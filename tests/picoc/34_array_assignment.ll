...
define i32 @main() {
L0:
  %a_000002882659D348 = alloca [4 x i32]
  %0 = bitcast [4 x i32]* %a_000002882659D348 to i32*
  %1 = bitcast i32* %0 to i8*
  %2 = getelementptr inbounds i8, i8* %1, i64 0
  %3 = bitcast i8* %2 to i32*
  store i32 12, i32* %3
  %4 = bitcast [4 x i32]* %a_000002882659D348 to i32*
  %5 = bitcast i32* %4 to i8*
  %6 = getelementptr inbounds i8, i8* %5, i64 4
  %7 = bitcast i8* %6 to i32*
  store i32 23, i32* %7
  %8 = bitcast [4 x i32]* %a_000002882659D348 to i32*
  %9 = bitcast i32* %8 to i8*
  %10 = getelementptr inbounds i8, i8* %9, i64 8
  %11 = bitcast i8* %10 to i32*
  store i32 34, i32* %11
  %12 = bitcast [4 x i32]* %a_000002882659D348 to i32*
