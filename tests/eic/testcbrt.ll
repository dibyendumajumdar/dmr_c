...
L0:
  %ux_000001581A63E108 = alloca %union.anno
  %ut_000001581A63E028 = alloca %union.anno
  %0 = alloca double
  %1 = bitcast %union.anno* %ut_000001581A63E028 to double*
  %2 = bitcast double* %1 to i8*
  %3 = getelementptr inbounds i8, i8* %2, i64 0
  %4 = bitcast i8* %3 to double*
  store double 1.000000e+00, double* %4
  %5 = bitcast %union.anno* %ut_000001581A63E028 to i32*
  ...
  %9 = bitcast %union.anno* %ut_000001581A63E028 to double*
  %10 = bitcast double* %9 to i8*
  %11 = getelementptr inbounds i8, i8* %10, i64 0
  %12 = bitcast i8* %11 to double*
  store double 0.000000e+00, double* %12
  %13 = bitcast %union.anno* %ux_000001581A63E108 to double*
  %14 = bitcast double* %13 to i8*
  %15 = getelementptr inbounds i8, i8* %14, i64 0
  %16 = bitcast i8* %15 to double*
  store double %ARG1, double* %16
  %R6 = bitcast %union.anno* %ux_000001581A63E108 to i8*
...
L4:                                               ; preds = %L2
  ...
  %R51 = bitcast %union.anno* %ut_000001581A63E028 to i8*
...
L5:                                               ; preds = %L4
  ...
  %36 = bitcast %union.anno* %ut_000001581A63E028 to double*
  ...
  %40 = bitcast %union.anno* %ut_000001581A63E028 to double*
...
L7:                                               ; preds = %L6, %L5
  %56 = bitcast %union.anno* %ut_000001581A63E028 to double*
  ...
  %60 = bitcast %union.anno* %ux_000001581A63E108 to double*
  ...
  %64 = bitcast %union.anno* %ut_000001581A63E028 to double*
  ...
  %81 = bitcast %union.anno* %ut_000001581A63E028 to double*
  ...
  %85 = bitcast %union.anno* %ux_000001581A63E108 to double*
  ...
  %89 = bitcast %union.anno* %ut_000001581A63E028 to double*
  ...
  %101 = bitcast %union.anno* %ut_000001581A63E028 to double*
