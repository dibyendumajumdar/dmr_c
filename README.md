...
* The LLVM backend takes the [SSA IR](https://github.com/dibyendumajumdar/dmr_c/blob/master/docs/instructions.md) generated by the linearizer in sparse and converts these to LLVM IR instructions.
...
* There is no support for computed gotos, slices and ranges yet in the llvm-backend.
