...
* WIP The codebase to be more C++ friendly so that it can be compiled using C++ compiler
...
* linearize - this tool outputs the SSA IR generated by the parser and compiler front-end. (Note that these instructions are converted by the sparse-llvm backend to LLVM IR)
