...
L1:
  %x_000001A9381CB158 = alloca [6 x i32]
  %x_000001A9381CADD8 = alloca [5 x i32]
  %R2 = bitcast [5 x i32]* %x_000001A9381CADD8 to i32*
  call void @init(i32* %R2)
  %0 = bitcast [5 x i32]* %x_000001A9381CADD8 to i32*
  %1 = bitcast i32* %0 to i8*
  %2 = getelementptr inbounds i8, i8* %1, i64 0
  %3 = bitcast i8* %2 to i32*
  %load_target = load i32, i32* %3
  %R9 = bitcast [6 x i32]* %x_000001A9381CB158 to i32*
  call void @init(i32* %R9)
  %4 = bitcast [6 x i32]* %x_000001A9381CB158 to i32*
