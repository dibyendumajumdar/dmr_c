...
define i32 @main() {
L0:
  %b_00000268BD26C3C8 = alloca i32
  %a_00000268BD26C2E8 = alloca i32
  %0 = bitcast i32* %a_00000268BD26C2E8 to i8*
  %1 = getelementptr inbounds i8, i8* %0, i64 0
  %2 = bitcast i8* %1 to i32*
  store i32 12, i32* %2
  %3 = bitcast i32* %b_00000268BD26C3C8 to i8*
  %4 = getelementptr inbounds i8, i8* %3, i64 0
  %5 = bitcast i8* %4 to i32*
  store i32 34, i32* %5
  %R6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 12)
  %6 = bitcast i32* %b_00000268BD26C3C8 to i8*
  ...
  %9 = ptrtoint i32* %a_00000268BD26C2E8 to i64
  %10 = ptrtoint i32* %b_00000268BD26C3C8 to i64
  ...
  %11 = ptrtoint i32* %a_00000268BD26C2E8 to i64
  %12 = ptrtoint i32* %b_00000268BD26C3C8 to i64
